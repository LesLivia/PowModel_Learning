...
from it.polimi.powmodel_learning.model.lshafeatures import Trace, TimedTrace, RealValuedVar, FlowCondition, \
    ProbDistribution
from it.polimi.powmodel_learning.model.sigfeatures import ChangePoint, Event, SampledSignal, Timestamp, SignalPoint
